...
describe("CertificationModal", () => {
  it("renders certification title", () => {
    render(<CertificationModal cert={mockCert} onClose={vi.fn()} lang="en" t={DICT.en} />);
  ...
  it("shows Indonesian description when lang is 'id'", () => {
    render(<CertificationModal cert={mockCert} onClose={vi.fn()} lang="id" t={DICT.id} />);
    expect(screen.getByText("Deskripsi dalam bahasa Indonesia")).toBeInTheDocument();
  });

  it("calls onClose when close button is clicked", () => {
    const onClose = vi.fn();
    render(<CertificationModal cert={mockCert} onClose={onClose} lang="en" t={DICT.en} />);
